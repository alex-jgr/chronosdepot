...
var map = po.map()
    .container(document.getElementById("contact_map").appendChild(po.svg("svg")))
    .center({lat: 47.0737779, lon: 21.916574399999945})
    .zoom(13)
    .zoomRange([12, 16])
    .add(po.interact());
...
map.add(po.geoJson()
    .url("/public/js/polymaps/examples/streets/streets.json")
    .id("streets")
    .zoom(12)
    .tile(false)
  .on("load", po.stylist()
